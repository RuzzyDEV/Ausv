  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        whatsapp: "bg-whatsapp text-primary-foreground hover:bg-whatsapp-hover hover:scale-105 shadow-lg hover:shadow-xl animate-pulse-glow",
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:scale-105 shadow-lg hover:shadow-2xl",
        gold: "bg-gradient-to-r from-secondary to-yellow-500 text-secondary-foreground hover:scale-105 shadow-lg font-bold",
      },
      size: {
